...
export function ProjectCard({ title, description, tags, image, demoUrl, repoUrl }: ProjectCardProps) {
  ...
  return (
    ...
    >
      <div
        className="relative h-full overflow-hidden rounded-xl bg-zinc-800/50 backdrop-blur-sm border border-zinc-700/50 transition-all duration-300 group-hover:border-sky-500/50"
        onMouseEnter={() => setIsHovered(true)}
        onMouseLeave={() => setIsHovered(false)}
      >
        <div className="absolute -inset-1 bg-gradient-to-r from-sky-500/10 to-cyan-500/10 rounded-xl blur opacity-25 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>
        ...
        <div className="relative h-full flex flex-col">
          ...
          <div className="p-6 flex-grow">
            ...
            <div className="flex justify-between mt-auto pt-4 border-t border-zinc-700/50">
              ...
              <Button
                size="sm"
                className="bg-gradient-to-r from-sky-500 to-cyan-500 hover:from-cyan-500 hover:to-sky-500 border-0"
                asChild
              >
